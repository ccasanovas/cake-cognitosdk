<?php
namespace Ccasanovas\CognitoSDK\Test\TestCase\Model\Behavior;
...
class AwsCognitoBehaviorTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        parent::setUp();
        $this->table = TableRegistry::get('Ccasanovas/CognitoSDK.ApiUsers');
    ...
    public function testBeforeSaveCreateCognitoUser()
    {
        ...
        $this->table->behaviors()->set('CognitoSDK', $behavior_mock);
    ...
    public function testChangeEmailFailUserNotSaved()
    {
        ...
        $this->expectExceptionMessage(__d('Ccasanovas/CognitoSDK', 'Cannot edit email of an nonexistent user.'));
    ...
    public function testChangeEmailFailMissingUsername()
    {
        ...
        $this->expectExceptionMessage(__d('Ccasanovas/CognitoSDK', 'The user does not have a Cognito Username.'));
        $this->Behavior->changeEmail($entity, $new_email, $require_verification);
    }
    ...
    public function testResendInvitationEmailFailUserNotSaved()
    {
        ...
        //requires entity to be saved
        $this->expectExceptionMessage(__d('Ccasanovas/CognitoSDK', 'You must create the entity before trying to resend the invitation email'));
    ...
    public function testGetWithCognitoDataSuccess()
    {
        ...
        $this->assertEquals([
            'code'        => 'CONFIRMED',
            'title'       => __d('Ccasanovas/CognitoSDK', 'Confirmed'),
            'description' => __d('Ccasanovas/CognitoSDK', 'The user account is confirmed and the user can sign in.'),
