<?php
namespace Ccasanovas\CognitoSDK\Test\TestCase\Controller\Api;

use Ccasanovas\CognitoSDK\Controller\Api\ApiUsersController;
...
class ApiUsersControllerTest extends IntegrationTestCase
{
    ...
    public function setUp()
    {
        ...
        Configure::write('Error', [
            'errorLevel' => E_ALL,
            'exceptionRenderer' => 'Ccasanovas\ApiGatewaySDK\Error\ApiExceptionRenderer',
            'skipLog' => [],
            'log' => true,
            'trace' => true,
        ]);
    ...
    protected function authorizeApiUser($content_length = false)
    {
        ...
        Configure::write('ApiGatewaySDK.api_id', $api_id);
