...
<?php
$fields = $fields ?? [
    'id'                   => __d('Ccasanovas/CognitoSDK', 'Id'),
    'aws_cognito_username' => __d('Ccasanovas/CognitoSDK', 'Aws Cognito Username'),
    'email'                => __d('Ccasanovas/CognitoSDK', 'Email') ,
    'first_name'           => __d('Ccasanovas/CognitoSDK', 'First Name'),
    'last_name'            => __d('Ccasanovas/CognitoSDK', 'Last Name'),
];
?>
...
<div class="APIUsers-validated-import container">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <span class="text-muted text-uppercase">
                                <?= __d('Ccasanovas/CognitoSDK', 'Total Submitted Users') ?>
                            </span>
                        </td>
                    </tr>
                    <?php if($stopped_at_max_errors): ?>
                     <tr>
                        ...
                        <td>
                            <span class="text-muted text-uppercase">
                                <?= __d('Ccasanovas/CognitoSDK', 'Errors Before Validation Stopped') ?>
                            </span>
                        </td>
                    </tr>
                    <?php endif; ?>
                    <tr>
                        ...
                        <td>
                            <span class="text-muted text-uppercase">
                                <?= __d('Ccasanovas/CognitoSDK', 'Validated Users') ?>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <span class="text-muted text-uppercase text-success">
                                <?= __d('Ccasanovas/CognitoSDK', 'Valid API Users') ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a data-toggle="modal" href="#" data-target="#modalValidated">
                                <?= __d('Ccasanovas/CognitoSDK', 'Show List of Valid API Users') ?> &raquo;
                            </a>
                        </td>
                    </tr>
                </tbody>
        ...
        <div class="footer">
            <div class="form-group">
                <button type="submit" role="button" class="btn btn-lg btn-primary">
                    <?= __d('Ccasanovas/CognitoSDK', 'Save changes') ?>
                </button>
                <?= $this->Html->link(__d('Ccasanovas/CognitoSDK', 'Cancel'), ['action' => 'import'], ['class' => 'btn btn-link']) ?>
            </div>
            <div class="text-muted note">
                <span class="glyphicon glyphicon-info-sign"></span>
                <strong><?= __d('Ccasanovas/CognitoSDK', 'Note') ?>:</strong>
                <?= __d('Ccasanovas/CognitoSDK', 'Keep in mind that proceeding will send emails to all new users with their login details.') ?>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="header">
            <h3 class="title"><?= __d('Ccasanovas/CognitoSDK', 'Validation Errors') ?></h3>
            <p><?= __d('Ccasanovas/CognitoSDK', '{0} Users did not pass the validation stage. Please review the errors and try again.', $invalid_api_users_count) ?></p>
        </div>
        <div class="content">
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th><?= __d('Ccasanovas/CognitoSDK', 'Row') ?></th>
        ...
        <div class="footer">
            <?= $this->Html->link(
                ...
                __d('Ccasanovas/CognitoSDK', 'Back to API Users Import Form'),
                ['action' => 'import'],
                ['escape' => false]
            ) ?>
        </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?= __d('Ccasanovas/CognitoSDK', 'Valid API Users') ?></h4>
      </div>
        ...
        <table class="table users-import">
            <tbody>
                <tr>
                    ...
                    <td>
                        <span class="text-muted text-uppercase">
                            <?= __d('Ccasanovas/CognitoSDK', 'New API Users will be added.') ?>
                        </span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <span class="text-muted text-uppercase">
                            <?= __d('Ccasanovas/CognitoSDK', 'API Users will be edited.') ?>
                        </span>
                    </td>
                </tr>
            </tbody>
            ...
            <thead>
                <tr>
                    <?php foreach($fields as $label): ?>
                        <th><?= $label ?></th>
                    <?php endforeach; ?>
                    <th><?= __d('Ccasanovas/CognitoSDK', 'Action') ?></th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(!$api_user->isDirty()): ?>
                            <?= __d('Ccasanovas/CognitoSDK', 'Unchanged') ?>
                        <?php elseif(!empty($api_user->id)): ?>
                            <?= __d('Ccasanovas/CognitoSDK', 'Edit') ?>
                        <?php else: ?>
                            <?= __d('Ccasanovas/CognitoSDK', 'Add') ?>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
